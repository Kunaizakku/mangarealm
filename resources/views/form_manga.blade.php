    ...
    <div class="container">
        ...
        <form class="form" action="{{route('man.insertar')}}" method="POST" >
            ...
            <div class="form-group">
                ...
                <input type="text" id="titulo" name="titulo" placeholder="Ingresa el nombre del título" required>
                <input type="text" id="descripcion" name="descripcion" placeholder="Escribe la descripción del manga" required>
                <input type="text" id="autor" name="autor" placeholder="Ingresa el nombre del autor" required>
                <input type="text" id="genero" name="genero" placeholder="Ingresa el género del manga" required>
